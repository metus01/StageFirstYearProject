...
<body>
        ...
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="col-md-6 text-start mb-5">
                    <h2 class="heading-section">Ajout d'année académique</h2>
                </div>
            </div>
            <div class="row justify-content-center">
                    ...
                    <div class="login-wrap p-4 p-md-5">
                        ...
                        <form action="" method="POST" class="login-form">
                            <div class="form-group">
                                <input type="text" class="form-control rounded-left" placeholder="2021-2022" required name="an">
                            </div>
                            <div class="form-group">
    ...
    if ($_POST) {
        ...
        $insertion2 =  $connexion->prepare("INSERT INTO annee(annee) VALUES (:annee)");

        $insertion2->bindParam(':annee', $_POST['an']);
